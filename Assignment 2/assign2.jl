...
# ╔═╡ 31838e28-8071-416b-9917-aae066cc352f
begin
...
# ╔═╡ df830a17-d753-4ff2-82a1-10ad05181b85
filedataValN = FileDataset("/Users/leonardopetrus/Desktop/CHEST_X-RAY/train/NORMAL")

# ╔═╡ 10bc0545-cadc-4f07-a579-ae70769c129f
filedataValP = FileDataset("/Users/leonardopetrus/Desktop/CHEST_X-RAY/train/PNEUMONIA")
...
function resize_gray(filedata, im_name, width=32, height=32)
...
function process_images(filedata, width=32, height=32)
    ...
    map(x -> resize_gray(filedata, x, width, height), files_list)
end
...
normal = vcat(filedataTrainN, filedataValN)

# ╔═╡ 7a1e95dd-f959-4d50-b4b3-bf9a7ccf912a
pneumonia = vcat(filedataTrainP, filedataValP)
...
# ╔═╡ db097ac7-5a00-47d1-a623-eadc52d93588
...
begin
    ...
    train_set = [minibatch(x_train, y_train, i) for i in mb_idxs]
    test_set = minibatch(x_test, y_test, 1:length(x_test));
end

# ╔═╡ a12b650b-bf5d-4413-b57f-6eae6634b07a
...
# ╔═╡ 3b9786df-b3e5-42cb-99f1-730385b70879
...
# ╔═╡ fcd30c85-a91a-426b-8802-7fb38ba8b000
